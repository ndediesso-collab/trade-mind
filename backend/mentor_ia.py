...
def analyser_ia_swing(app_instance,  nouvelle_analyse, actif, data_json=None, client_architect=None, *args, **kwargs):
    mode_upper = "SWING"
...
def analyser_ia_daily(app_instance, nouvelle_analyse,actif, data_json=None, client_architect=None, *args, **kwargs):
    mode_upper = "DAILY"
...
def analyser_ia_scalp(app_instance,nouvelle_analyse, actif, data_json=None, client_architect=None, *args, **kwargs):
    mode_upper = "SCALP"
